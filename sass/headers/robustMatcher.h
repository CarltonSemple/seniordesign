...
class RobustMatcher {
  ...
  public:
	  ...
	  RobustMatcher() : ratio(0.65f), refineF(true), confidence(0.99), distance(3.0) {	  
		  ...
		  detector= cv::xfeatures2d::SURF::create();//cv::FeatureDetector::create("SURF"); //new SurfFeatureDetector();
		  //extractor= cv::xfeatures2d::DescriptorExtractor::create("SURF"); //new SurfDescriptorExtractor();
	  }
	  ...
	  cv::Mat match(cv::Mat& image1, cv::Mat& image2, // input images 
		...
		cv::BFMatcher matcher;//(cv::L2<float>);
